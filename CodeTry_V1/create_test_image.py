...
def create_gradient_image(size=224, save_path='test_image.jpg'):
    """Create a gradient test image with patterns"""
...
if __name__ == "__main__":
    ...
    print("\nNow you can run this command to test patch extraction:")
    print(f"python test_custom_image.py --image {image_path}") 